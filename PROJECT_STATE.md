...
- Admin foundations include protected authentication boundaries, content review workspace, pack readiness/release panel and owner-only splash replacement control. Isolated Admin staging now runs the reviewed LB-DS-054 operation merged in PR #262 at `7d2d615`: an encrypted restorable backup was proven, migration `0017` has the reviewed checksum and yielded `35 / 210 / 210 / 0 / 0`, and only the protected Admin review runtime is enabled. Anonymous session/review reads remain `401` with `no-store`, bootstrap remains `404`, rollback to the retained image was proven, and the owner verified the server-backed queue through Passkey outside chat. Production, learner delivery, seed, review decisions and publication remain unchanged.
