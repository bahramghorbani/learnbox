...
1. Begin S1 with the isolated private-media target decision.
2. Keep learner seed/activation downstream of human content approval.
3. Do not admit post-v1 scope into the v1.0 critical path without a decision record and reforecast.
