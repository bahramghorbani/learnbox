...
when they share one production server, and
[ADR 0011](0011-native-mobile-session-and-transport.md), which proposes the
default-disabled native mobile session and authenticated review transport.
