...
| Content/media QA queue               | Verified foundation | Admin preview shows the complete Start Pack review queue and six-dimensional gate; authenticated persistence and real reviewer actions remain gated |
