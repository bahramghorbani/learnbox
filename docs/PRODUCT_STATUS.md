...
| Today daily learning session        | Web / Android       | Verified foundation   | Three-card Start flow and active recall tests; expand to server-backed catalog |
...
| User offline tolerance              | Web / Android       | Verified foundation   | Local queue/recovery exists; online-first server reconciliation is next        |
| Online account/auth                 | Web                 | Partial / gated       | Browser auth foundation exists; production activation remains gated            |
