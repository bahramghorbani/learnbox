...
| User offline tolerance              | Web / Android       | Verified foundation   | Local queue/recovery exists; truthful loading/error/offline labels on Today; push-reconciliation cursor/watermark policy approved (ADR 0014); server implementation remains a serial M1-D queue task                                                                                                                    |
