...
| Profile / Settings         | Owner-approved bounded contract              | No complete product surface; `M3_PROFILE_SETTINGS_CONTRACT.md` records approved fourth-tab navigation and fail-closed sign-out/deletion policies without claiming implementation                                                                                                                                                                                             | Not implemented   | Separately scoped P1/S1 implementation with state-complete review   |
