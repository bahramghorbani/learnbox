...
| Words                      | Reviewed concept + implemented base          | Web separates canonical/personal words and implements source/search recovery (PRs #217/#223); Android LB-DS-036 adds offline German/Persian search and truthful clear recovery over bundled official words | Partial           | Personal-word Android parity and server-backed catalog/sync states            |
