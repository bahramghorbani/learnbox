...
| Words                      | Reviewed concept + implemented base          | Web list/search separates canonical and personal words, labels source, preserves truthful personal quota, exposes fresh/search empty states (PR #217), and adds source filters plus clear-search recovery (LB-DS-035) | Partial           | Loading/error/offline/server-sync states and Android parity                   |
