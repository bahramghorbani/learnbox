...
| Words                      | Reviewed concept + implemented base          | Web list/search now separates canonical and personal words, labels source, preserves truthful personal quota and exposes fresh/search empty states | Partial           | Filter chips, loading/error/offline/server-sync states and Android parity     |
