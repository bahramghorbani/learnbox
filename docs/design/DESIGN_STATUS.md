...
| Profile / Settings         | Direction + decision-ready contract proposal | No complete product surface; `M3_PROFILE_SETTINGS_CONTRACT.md` records the proposed navigation, truthful states, accessibility and pending-data/sign-out gate without claiming owner approval                                                                                                                                                                                | Not implemented   | Owner decisions M3-D-1 through M3-D-3, then separately scoped implementation |
...
2. **D1 — Complete learner UI kit:** finalize Splash, Onboarding, Today, Review, Words, Progress, Profile and Settings, including loading, empty, error, offline and sync states. State board: [`D1_LEARNER_UI_KIT.md`](./D1_LEARNER_UI_KIT.md) (draft, ready for review).
   The Profile/Settings follow-up is a decision-ready, unapproved proposal in
   [`M3_PROFILE_SETTINGS_CONTRACT.md`](./M3_PROFILE_SETTINGS_CONTRACT.md); it is not implementation
   authorization.
