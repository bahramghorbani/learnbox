...
| Words                      | Reviewed concept + implemented base          | Web separates canonical/personal words and implements source/search recovery (PRs #217/#223); Android adds offline search plus secure device-local personal words, cross-source duplicate checks, quota and recovery in LB-DS-037 at `9f23c72` | Partial           | Server-backed catalog/personal vocabulary and truthful sync states            |
