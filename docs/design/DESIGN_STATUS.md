...
| Profile / Settings         | Owner-approved bounded contract              | Android M3-P1 in Draft PR #237 (`feature/m3-android-profile-settings`): Profile is the fourth persistent destination (PDR-006) showing the neutral account label and the real device-local pending count; Settings is a child surface with approved informational rows and focus-restoring labelled back action; widget tests cover loading/zero/positive/error/retry pending states, focus/back, RTL, large text and target layouts (11/11 focused, 203/203 Flutter); independent review PASS | Partial           | Web M3-P1 (LB-DS-042); M3-S1 sound/goal preference persistence; account-scoped storage before sign-out |
