...
| Words                      | Reviewed concept + implemented base          | Web separates canonical/personal words and implements source/search recovery (PRs #217/#223); Android offline German/Persian search and truthful clear recovery merged in PR #225 | Partial           | Personal-word Android parity and server-backed catalog/sync states            |
