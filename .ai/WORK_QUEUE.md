...
- **M2 content-review safety gate:** review-gated implementation in progress on a dedicated branch; approval must require all six `content_review_checks` dimensions to be `passed`; no publication or provider activation is included.
