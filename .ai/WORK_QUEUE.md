...
- Draft PR required: yes
- Merge allowed: yes
- Blocked on: replacement exact-head review and CI after remediation of the `3034715` review findings; it may proceed in parallel because its production/test paths are disjoint from LB-DS-070.
