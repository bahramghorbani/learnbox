...
- Head commit: read live from the Draft PR before readiness or merge
...
- Checks unavailable: independent exact-head review and seven GitHub/Vercel contexts remain pending until the Draft PR exists.
- Remaining work: validate, independently review, open the Draft PR, obtain seven terminal-success contexts and merge; then request the owner's separate guarded private-upload/attachment decision.
