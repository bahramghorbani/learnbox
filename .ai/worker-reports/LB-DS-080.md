...
record cannot pass silently. After the minimal implementation the focused suite passed 72/72 across
three consecutive runs; after the semantic hardening above it passes 73/73, including direct coverage
of the zero-public-copy and all-public-copy extremes. The mutation fixtures listed in the
validator/build tests fail closed
