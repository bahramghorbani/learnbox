...
- Remaining work: M3-S1 sound/goal preference persistence and account-scoped storage/sign-out remain later serial tasks; support/privacy external-link rows remain deferred because Android has no in-scope approved destination or URL-launch dependency (omission is deliberate and fail-closed, mirroring PDR-006). Web M3-P1 merged separately in PR #238.
