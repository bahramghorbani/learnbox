...
- Head commit: read live with `gh pr view 260 --json headRefOid` immediately before readiness or merge; branch-authored metadata cannot self-attest its own final commit SHA.
