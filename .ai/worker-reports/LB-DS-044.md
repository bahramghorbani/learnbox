...
- Draft PR: #240 (merged at `9771dde78a1cec60bdefb8ba05864e3b4a7ad699`) — https://github.com/bahramghorbani/learnbox/pull/240
...
- Remaining work: LB-DS-045 owns the fail-closed evidence-metadata reconciliation; with separate cost authorization, produce candidate-only media and QA for the remaining 15; then obtain per-item owner release decisions before any attachment, seed, flag enablement, participant invitation or publication
...
- The original 20 have candidate-stage provenance, visual and local app-flow evidence. Their 60 V1
  assets and 20 V2 image assets are privately attested but deliberately unattached; the V1 audio set
  has candidate-stage transcription QA. Issue #59 V2 audio regeneration remains incomplete: 6/40
  listening-approved, 34/40 pending/absent and four transcription mismatches.
...
- Both draft batches and candidate intakes retain pre-approval status/source wording for the
  later-approved linguistic dimensions; the 15-item provenance ledger still lists those dimensions
  as pending; the audit treats this and Issue #59 gate/ledger divergence as chronology drift and does
  not infer any additional approval.
