...
- Remaining work: verify independent exact-head review and every exact-head PR check on the live final head, then merge; afterward start LB-DS-062 from the resulting main SHA.
