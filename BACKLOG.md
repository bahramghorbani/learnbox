...
| P0       | Validate 20 real items in web/mobile: media, scheduling, offline, progress and Bobo QA | source-referenced candidates and editorial review | intake ready; card data and media pending   | requires_new_task           |
