...
| P0       | Validate 20 real items in web/mobile: media, scheduling, offline, progress and Bobo QA | owner linguistic approval and media/app validation | source scope, schedule coverage and web staging verified; media/app QA pending | requires_new_task           |
