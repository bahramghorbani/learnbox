...
| P0       | Validate 20 real items in web/mobile: media, scheduling, offline, progress and Bobo QA | source-referenced drafts and named editorial reviewer | review packet ready; media and app QA pending | blocked_by_owner            |
